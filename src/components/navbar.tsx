    ...
    <div className="border-b-2 borber-b-black dark:border-b-white w-full bg-white dark:bg-neutral-900 text-black dark:text-white">
        <nav className="flex flex-col items-center gap-3 max-w-screen-lg m-auto p-2 md:flex-row md:justify-between">
            ...
            <ul className="flex flex-col items-center gap-12 font-bold sm:flex-row sm:justify-between">
                <Link className="transition ease-in-out hover:scale-x-105 hover:text-gray-700" href="/">
                    <a>Home</a>
                </Link>
                <Link className="transition ease-in-out hover:scale-x-105 hover:text-gray-700" href="/bateponto">
                    <a>Bate-Ponto</a>
                </Link>
                <Link className="transition ease-in-out hover:scale-x-105 hover:text-gray-700" href="/administrativo">
                    <a>Administrativo</a>
                </Link>
            </ul>
        </nav>
